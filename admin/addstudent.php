...
<div class="container jumbotron">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<h2 class="text-center">NEW KID ENTRY</h2>
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				      Appointment no:<input type="text" class="form-control" name="roll" placeholder="Enter Appointment no" >
				  </div>
				  <div class="form-group">
				    
				    Name:<input type="text" class="form-control" name="fullname" placeholder="name" required>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    Age:<input type="number" class="form-control" name="standard" placeholder="Enter Kid's Age" required>
				  </div>
