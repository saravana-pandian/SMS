...
<div class="container jumbotron">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<h2 class="text-center">UPDATE KID DETAIL</h2>
			<form action="UpdateRecord.php?update_id=<?php echo $update_id;?>" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				      Appoinment No.:<input type="text" class="form-control" name="roll" value="<?php echo 
				      $Roll;?>" >
				  </div>
				  <div class="form-group">
				    
				    Name:<input type="text" class="form-control" name="fullname" value="<?php echo 
				  ...
				  <div class="form-group">
				    ...
				    Age:<input type="number" class="form-control" name="standard" value="<?php echo $Standard;?>" required>
				  </div>
